...
namespace utils3d {
	...
	namespace importobjects {
		...
		void WavefrontMtlfactory::setMaterialIluminationModel(string line, WavefrontMtl* obj3D){
			...
			LOG4CXX_TRACE(logger,"Ilumination Model: " << obj3D->actualMaterial->illuminationModel);
		}
		...
		void WavefrontMtlfactory::setMaterialDiffuseReflectivity(string line, WavefrontMtl* obj3D){
			...
			LOG4CXX_TRACE(logger,"Diffuse Reflectivity: " << obj3D->actualMaterial->diffuseReflectivity.x << " " << obj3D->actualMaterial->diffuseReflectivity.y << " " << obj3D->actualMaterial->diffuseReflectivity.z);
		}
		...
		void WavefrontMtlfactory::setMaterialAmbientReflectivity(string line, WavefrontMtl* obj3D){
			...
			LOG4CXX_TRACE(logger,"Ambient Reflectivity: " << obj3D->actualMaterial->ambientReflectivity.x << " " << obj3D->actualMaterial->ambientReflectivity.y << " " << obj3D->actualMaterial->ambientReflectivity.z);
		}
		...
		void WavefrontMtlfactory::setMaterialTransmissionFilter(string line, WavefrontMtl* obj3D){
			...
			LOG4CXX_TRACE(logger,"Transmission Filter: " << obj3D->actualMaterial->transmissionFilter.x << " " << obj3D->actualMaterial->transmissionFilter.y << " " << obj3D->actualMaterial->transmissionFilter.z);
		}
		...
		void WavefrontMtlfactory::setMaterialOpticalDensity(string line, WavefrontMtl* obj3D){
			...
			LOG4CXX_TRACE(logger,"Optical Density: " << obj3D->actualMaterial->opticalDensity);
		}
